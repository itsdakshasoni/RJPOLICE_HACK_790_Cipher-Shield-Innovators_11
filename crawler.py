...
KEYWORDS = {'hidden', 'more', 'gun', 'seller', 'porn', 'news', 'Dark ebay', 'bitcoin', 'vendor', 'seller account',
            'price', 'carding', 'bank transer', 'contact me', 'pay pal', 'Onion escrow', 'BlackMarketCCP@cock.li',
            'sex'}
